...
public class ActivitySequencer implements Startable {
    ...
    private final StanzaListener activitiesStanzaListener = new StanzaListener() {
    ...
    public void start() {
        ...
        receiver.addStanzaListener(activitiesStanzaListener,
            ActivitiesExtension.PROVIDER.getStanzaFilter(currentSessionID));

        activitySendThread = ThreadUtils.runSafeAsync("activity-sender", LOG,
            activitySender);
    }
    ...
    public void stop() {
        ...
        receiver.removeStanzaListener(activitiesStanzaListener);
    ...
    private void sendActivities(JID recipient, List<IActivity> activities,
        ...
        while (it.hasNext()) {
            ...
            final ExtensionElement activityExtensionElement = ActivitiesExtension.PROVIDER
    ...
    private void receiveActivities(Stanza activityPacket) {
