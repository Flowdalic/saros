...
public class RosterTracker {
    ...
    public List<Presence> getPresences(JID from) {
        ...
        final Iterator<Presence> it = currentRoster
            .getPresences(from.toString());
    ...
    private void prepareConnection(XMPPConnection connection) {
        this.connection = connection;
        setRoster(this.Roster.getInstanceFor(connection));
    }
